...
proc setup {tcptype queuetype sources qlen duration file seed c_sources delay rate ecn} {
	...
	$n(100) interface-errormodel [$val(err)]
	
	$ns_ unset satNodeType_
	
	# create regular routers
	set n(99) [$ns_ node]    ;#....node 2
	...
	$ns_ duplex-link $n(99) $n(100) 10Mb 50ms $queuetype
...
# 	# TCP
 	set tcp [$ns_ create-connection $tcptype $n(99) TCPSink/Sack1 $n(0) 0]
