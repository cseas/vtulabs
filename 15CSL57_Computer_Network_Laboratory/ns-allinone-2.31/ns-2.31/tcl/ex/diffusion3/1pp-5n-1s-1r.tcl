#
# A 1 phase pull example
# This example tests directed diffusion in a 5 node scenario with 1 sender 
# and 1 recvr
#
# ==================================================================
# Define options
...
set opt(tr)		"1pp-5n-1s-1r.tr"	;# trace file
set opt(nam)            "1pp-5n-1s-1r.nam"  ;# nam file
...
puts $tracefd "Directed Diffusion:$opt(filters)"
