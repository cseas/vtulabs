...
# This example tests directed diffusion in a 10 node scenario with a 4 senders and a single recvr
#
# ==================================================================
# Define options
# ===================================================================
...
set opt(sndr)            4      ;# no of senders
set opt(rcvr)            1      ;# no of recvrs
set opt(seed)		0.0
set opt(stop)		100	;# simulation time
set opt(prestop)        199       ;# time to prepare to stop
set opt(tr)		"2pp-10n-4s-1r.tr"	;# trace file
set opt(nam)            "2pp-10n-4s-1r.nam"  ;# nam file
